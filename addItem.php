...
<div id="container">
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="page-header">
            <h2><span class="glyphicon glyphicon-tower"></span> &nbsp; Add News Item</h2>
        </div>
        ...
        <div ng-app="myApp" ng-controller="customersCtrl">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="title" ng-model="title" required ng-minlength="2" ng-maxlength="50" ng-pattern="/^[A-Za-z ]+$/"/><br />
                ...
                <tr>
                    ...
                    <td><input type="text" name="subTitle" ng-model="subTitle" required ng-minlength="2" ng-maxlength="50"/>
